...
<div class="cat">
    ...
    <div class="cat-content">
        <img src="./img/visit/18.png" alt="">
        <h1 class="heading">Nasiyan Jain Temple Ajmer</h1>
        <h1 class="heading"><img class="logo" src="./img/p4.1.png" alt=""></h1>
        <p>
            Nasiyan Jain Temple is a sacred Tirtha of Digambar Jains in the suburban area of Ajmer. It is getting popular amongst the tourist for its beautiful architecture and intricate stone carvings which gives both traditional and contemporary look. The temple is made of marble stone and is known for fulfilling wishes and bringing prosperity in life. The main temple has a huge idol of Guru Adinath Ji on the 1st floor with 24 miniature temples of other Tirthankar's line up on the hills above. The view from the top is spectacular and breathtaking. It is constructed in the Aravali Ranges by the marble giant Mr. Ashok Patni of RK Marbles.

            The temple timings are from 6.30 AM to 7 PM (7 days a week).</p>
        <br>
